...
Prints a label for load average.
	7.	uptime | awk -F'load average:' '{print $2}'
	...
	15.	free -m | awk 'NR==2{printf "Used: %sMB / Total: %sMB (%.2f%%)\n", $3, $2, $3*100/$2 }'
	...
	17.	df -h | awk '$NF=="/"{printf "Used: %dGB / Total: %dGB (%s)\n", $3, $2, $5}'
	...
	19.	ps aux --sort=-%cpu | head -n 6 | awk '{print $1, $2, $3, $4, $11}'
	...
	21.	ps aux --sort=-%mem | head -n 6 | awk '{print $1, $2, $3, $4, $11}'
